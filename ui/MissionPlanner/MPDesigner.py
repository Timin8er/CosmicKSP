...
class Ui_MissionPlannerWindow(object):
    def setupUi(self, MissionPlannerWindow):
        ...
        self.commandSequenceToolsLayout.addItem(spacerItem)
        ...
        self.commandToolsLayout.addItem(spacerItem2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 308, 347))
