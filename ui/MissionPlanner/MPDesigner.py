...
class Ui_MissionPlannerWindow(object):
    def setupUi(self, MissionPlannerWindow):
        ...
        self.commandSequencesView = QtWidgets.QListView(self.commandSequencesGB)
        self.commandSequencesView.setObjectName("commandSequencesView")
        self.verticalLayout_3.addWidget(self.commandSequencesView)
        ...
        self.commandsView = QtWidgets.QListView(self.commandsGB)
        self.commandsView.setObjectName("commandsView")
        self.commandToolsLayout.addWidget(self.commandsView)
